...
dir = '/mnt/hadoop/se/store/user/jbrinson/WToTauNu_PU_2/'
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/data/users/jbrinson/FiveHits_2/WtoLNuFiveHits_Reco_'+processPostfix + '.root'),
